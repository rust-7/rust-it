...
export declare abstract class DatabaseDriver<C extends Connection> implements IDatabaseDriver<C> {
    ...
    abstract nativeInsertMany<T extends AnyEntity<T>>(entityName: string, data: EntityData<T>[], ctx?: Transaction): Promise<QueryResult>;
    ...
    protected shouldHaveColumn<T extends AnyEntity<T>>(prop: EntityProperty<T>, populate: PopulateOptions<T>[], includeFormulas?: boolean): boolean;
    /**
     * @inheritDoc
     */
